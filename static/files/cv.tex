...
% ($*$ Citadel)\\
 ...
 \item {\bf Undergrad Research: Biomedial Mathematics Group}, Spring 2021 - Present. \\
{\bf Supervisor:} Prof. Jaekyoung Kim (Dept. of Mathematical Sciences, KAIST) \\
{\bf Collaborator:} Seokmin Ha$^{*}$, ???$^{*}$ (*Dept. of Mathematical Sciences, KAIST) \\
{\bf Research topic:} {\it Applying deep learning to parameter inference of stochastic models of gene expression } \\

 \item {\bf Undergrad Research: COINSE Lab}, Fall 2021 - Present. \\
...
\item {\bf CSHS Mathematics Research and Education Program (R\&E)}, Mar 2015 - Feb 2017. \\
 {\bf Supervisor:} Mr. Seungkyun Cha (Division of Mathematics, CSHS) \\
 {\bf Advisor:} Prof. Jisoo Byun (Dept. of Mathematics Education, Kyungnam University) \\
...
\begin{enumerate}
	...
	``Can Fairness in Principal Components be Obtained, Even in High Dimensions?'' (Under review)

	\item
	\textbf{Junghyun Lee}$^\star$, Chani Jung$^\star$, Yoo Hwa Park$^\star$, Dongmin Lee$^\star$, Juyeon Yoon, Shin Yoo.
	``SWAY for Decision Space of Permutations, with Case Study on Test Case Prioritisation'' (Work in progress) \\
