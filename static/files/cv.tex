...
\begin{enumerate}
	\item
	\textbf{Junghyun Lee}, Gwangsu Kim, Chang Dong Yoo.
	``Fair Sparse PCA for Block-Structured Datasets via Manifold Optimization" (Work in progress, Unpublished)

	\item
\textbf{Junghyun Lee}, Se-Young Yun.
``Robust Weight Initialization Scheme of Deep Neural Networks inspired from Self-Regularization" (Work in progress, Unpublished)
\end{enumerate}
...
\myEnumReset
\subsubsection*{OTHERS (e.g. coursework)}
\begin{enumerate}
	...
	``Korean QA Task on Naver KorQuAD-like Dataset",
	{\it CS492(I): Special Topics in Computer Science <Deep Learning for Real-World Problems>}, 2020 Fall. (Work in progress)
