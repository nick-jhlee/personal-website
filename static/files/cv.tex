...
% ($*$ Citadel)\\
 ...
 \item {\bf Undergrad Research: Biomedical Mathematics Group}, Spring 2021 - Present. \\
{\bf Advisor:} Prof. Jae Kyoung Kim (Dept. of Mathematical Sciences, KAIST) \\
{\bf Collaborator:} Seokmin Ha$^{*}$, Yun Min Song$^{*}$, Hyukpyo Hong$^{*}$, Dae Wook Kim$^{*}$ (*Dept. of Mathematical Sciences, KAIST) \\
{\bf Research topic:} {\it Applying machine/deep learning to non-parametric inference of (delay) distributions} \\
...
\begin{itemize}
	...
	{\bf Instructor:} Prof. Eunho Yang (School of Computing, KAIST) \\
