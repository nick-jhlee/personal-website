...
\begin{enumerate}
	...
	\item
	\textbf{Junghyun Lee}$^\star$, Chani Jung$^\star$, Yoo Hwa Park$^\dag$, Dongmin Lee$^\dag$, Juyeon Yoon, Shin Yoo.
	``Preliminary Evaluation of SWAY in Permutation Decision Space via a Novel Euclidean Embedding'' (Under review) \\
	($\star$, $\dag$: equal contributions)
