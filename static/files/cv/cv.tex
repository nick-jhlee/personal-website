...
\begin{itemize}
	...
	\item {\bf Graduate (Associate) Researcher at COINSE, School of Computing, KAIST, South Korea.}
\begin{itemize}
	\item (Summer 2021 - Present) New Euclidean embedding for permutation decision space in SBSE, with preliminary analysis on TCP - {\it Joint Principal Investigator}
\end{itemize}
\end{itemize}
...
\begin{itemize}
 ...
 \item {\bf Optimization and Statistical Inference Lab (OSI Lab), GSAI, KAIST, South Korea}, Spring 2020 - Summer 2021. \\
...
% ($**$ Currently Post-doctoral associate of Center for Data Science at NYU)\\\dfrac{num}{den}
...
%{\bf Research topic:} {\it Fair Graph Analysis (TBD) } \\
 ...
 \item {\bf Artificial Intelligence \& Machine Learning Lab (AIM Lab), School of EE, KAIST, South Korea}, Fall 2019 - Summer 2021. \\
...
% ($*$ Citadel)\\
 ...
 \item {\bf Biomedical Mathematics Group (BIMAG), IBS, South Korea}, Spring 2021 - Summer 2021. \\
...
{\bf Research topic:} {\it Applying machine learning methodologies to plant circadian clock model inference} \\
 ...
 \item {\bf Computational Intelligence for Software Engineering Lab (COINSE Lab), School of Computing, KAIST, South Korea}, Fall 2020 - Summer 2021. \\
...
% ($**$ Currently Post-doctoral associate of Center for Data Science at NYU)\\
 ...
 \item {\bf [Alone] Individual Study, Dept. of Mathematical Sciences, KAIST, South Korea}, Summer 2019 - Fall 2019. \\
...
\item {\bf CSHS Mathematics Research and Education Program (R\&E), South Korea}, Mar 2015 - Feb 2017. \\
...
\begin{enumerate}
	\item
	\textbf{Junghyun Lee}, Gwangsu Kim, Matt Olfat, Chang D. Yoo.
	``Fair PCA via Optimization over Stiefel Manifold (tbd)'' (Work in progress)
...
\begin{enumerate}
	\item \textbf{Junghyun Lee}$^\star$, Chani Jung$^\star$, Yoo Hwa Park, Dongmin Lee, Juyeon Yoon, Shin Yoo.
	``Preliminary Evaluation of SWAY in Permutation Decision Space via a Novel Euclidean Embedding'' In \textit{Symposium on Search-Based Software Engineering (SSBSE 2021)}\\
...
\begin{itemize}
	...
	%	\item {\bf CS330: Operating Systems and Lab}, Spring 2019. \\
	%	{\bf Instructor:} Prof. Youngjin Kwon (School of Computing, KAIST) \\
	%	{\bf Collaborator:} Hyunjin Kim (School of Computing, KAIST) \\
	%	{\bf Project topic:} {\it Building PintOS, a small (toy) operating system} \\
...
\begin{enumerate}
	...
	``Lecture Note 5: Randomized Algorithms'',
	{\it CS500: Design and Analysis of Algorithm}, 2020 Spring.
...
\begin{itemize}
	\item Languages: \textbf{Python, Matlab % Mathematica
%	C,
%	Java,
%	Kotlin,
%	Scala
...
\begin{itemize}{}{}
	...
	\item \textbf{English}: Highly proficient  \\ % \st{Almost native} 
	TOEIC 985/990 (2021)
...
%
%\begin{itemize}{}{}
%	\item Associate Professor, Graduate School of AI (KAIST)
%	\item OSI Lab
%\end{itemize}
%
%
...
%
%\begin{itemize}
%	\item Professor, School of Electrical Engineering (KAIST)
%	\item AIM Lab
%\end{itemize}
%
%
...
%
%\begin{itemize}{}{}
%	\item Research Professor, School of Electrical Engineering, (KAIST)
%	\item AIM Lab
%\end{itemize}
...
%
%\begin{itemize}{}{}
%	\item Associate Professor, Dept. of Mathematical Sciences (KAIST)
%	\item BIMAG
%\end{itemize}
